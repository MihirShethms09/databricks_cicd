# asset_bundles_tutorial

The 'asset_bundles_tutorial' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/asset_bundles_tutorial/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] asset_bundles_tutorial_etl` to your workspace.
